...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TheFacility", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("TheFacility", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TheFacility";
		app.meta["name"] = "TheFacility";
