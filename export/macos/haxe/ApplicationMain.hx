...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("19DollaFortniteCard", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("19DollaFortniteCard", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "19DollaFortniteCard";
		app.meta["name"] = "19DollaFortniteCard";
